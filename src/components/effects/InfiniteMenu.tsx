    ...
    <div className="relative h-full w-full">
      ...
      {activeItem && (
        <>
          ...
          select-none
          ${isMoving ? "pointer-events-none opacity-0 duration-[100ms]" : "pointer-events-auto opacity-100 duration-[500ms]"}
        `}>{activeItem.title}</h2>
          ...
          ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
          select-none
          ${isMoving ? "pointer-events-none translate-x-[-60%] -translate-y-1/2 opacity-0 duration-[100ms]" : "pointer-events-auto translate-x-[-90%] -translate-y-1/2 opacity-100 duration-[500ms]"}
        `}>{activeItem.description}</p>
          ...
          transition-all
          ease-[cubic-bezier(0.25,0.1,0.25,1.0)]
          ${isMoving ? "pointer-events-none bottom-[-80px] -translate-x-1/2 scale-0 opacity-0 duration-[100ms]" : "pointer-events-auto bottom-[3.8em] -translate-x-1/2 scale-100 opacity-100 duration-[500ms]"}
        `}>
            <p className="relative top-[2px] text-[26px] text-[#060010] select-none">&#x2197;</p>
          </div>
        </>
      )}
    </div>
